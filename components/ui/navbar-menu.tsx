...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full w-1/2 mx-auto border border-transparent dark:bg-black dark:border-white/[0.2] bg-white shadow-input flex justify-center space-x-4 px-8 py-6 "
    >
      {children}
    </nav>
  );
