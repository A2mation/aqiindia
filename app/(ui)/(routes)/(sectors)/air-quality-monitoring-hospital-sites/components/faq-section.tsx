...
export function FAQSection() {
    ...
    const faqs = [
        {
            question: "Track Environmental Conditions:",
            answer:
                "Offer real-time pollution data, allowing hospitals to anticipate high pollution periods and plan resource allocation.",
        },
        {
            question: "Optimize Hospital Response:",
            answer:
                "Help facilities manage patient surges effectively by adjusting staff levels and medical supplies in response to data insights.",
        },
    ]
