    ...
    const steps = [
        {
            ...
            description:
                "Enable hospitals to prepare for & mitigate pollution-related health emergencies with precise data from Air Quality Monitors.",
        },
        {
            number: "02",
            title: "Superior Patient Management:",
            description:
                "Predictive insights allow for better care during critical pollution times, improving treatment success.",
        },
        {
            number: "03",
            title: "Operational Excellence:",
            description:
                "Efficient resource and staff management reduce hospital overload and enhance care during pollution peaks.",
        },
        {
            number: "04",
            title: "Informed Health Decisions:",
            description:
                "Analytical trends provide hospitals with the foresight needed to tackle environmental health challenges proactively.",
        },
        {
            number: "05",
            title: "Leadership in Community Health:",
            description:
                "Using data to inform the public and influence health policies, hospitals strengthen community health frameworks.",
        },
    ]
